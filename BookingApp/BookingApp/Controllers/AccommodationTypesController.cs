...
namespace BookingApp.Controllers
{
    public class AccommodationTypesController : ApiController
    {
        ...
        {
            AccommodationType accommodationType = db.AccomondationTypes.Find(id);
        ...
        public IHttpActionResult PostAccommodationType(AccommodationType accommodationType)
        {
            ...
            db.AccomondationTypes.Add(accommodationType);
            db.SaveChanges();
        ...
        public IHttpActionResult DeleteAccommodationType(int id)
        {
            ...
            db.AccomondationTypes.Remove(accommodationType);
            db.SaveChanges();
        ...
        {
            return db.AccomondationTypes.Count(e => e.Id == id) > 0;
        }
    }
}